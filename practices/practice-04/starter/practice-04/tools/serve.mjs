// Готовый локальный сервер статических файлов. Разработка сервера не входит в ПР4.
...
const port = Number(process.argv[2] ?? 5504);
...
server.listen(port, "127.0.0.1", () => {
  console.log(`ПР4: http://127.0.0.1:${port}/`);
