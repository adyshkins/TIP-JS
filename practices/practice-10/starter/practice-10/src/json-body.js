// Инфраструктура предоставлена; отдельная установка body-parser не нужна.
import express from 'express';
import { ApiError } from './errors.js';
const parse = express.json({
  limit: 16 * 1024, strict: false, inflate: false,
  verify(req, res, buffer) { req.jsonBodyBytes = buffer.length; },
});
